...
Route::view('/cliente', 'principalCliente')->name('principalCliente')->middleware("tipo");
...
Route::middleware([\App\Http\Middleware\VerificarAutenticacion::class])->group(function () {
    ...
    Route::post('/consumirServicio', [ConsumirServicioController::class, 'RecolectarDatos'])->name('consumirServicio.recolectar');
    Route::post('/venta', [VentaController::class, 'generarVenta'])->name('venta.generar');
    Route::post('/comprar', [CompraController::class, 'registrarCompra'])->name('compra.registrar');
    ...
    Route::prefix('reportes')->group(function () {
        ...
        Route::get('productos', [ReporteController::class, 'index'])->name('reportes.productos');
    });
    ...
    Route::prefix('busqueda')->group(function () {
        Route::get('index', [BusquedaController::class, 'index'])->name('busqueda.index');
    });
...
Route::get('/detalles-registro/{nombreTabla}/{idRegistro}', [BusquedaController::class, 'obtenerDetallesRegistro'])->name('detalles-registro');
...
// Rutas para el controlador de reportes de compras
...
// Rutas para el controlador de reportes de ventas
