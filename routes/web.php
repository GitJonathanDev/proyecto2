...
Route::prefix('ventas')->group(function () {
    ...
    Route::get('{codVenta}/edit', [VentaController::class, 'edit'])->name('venta.edit');
    Route::put('{codVenta}', [VentaController::class, 'update'])->name('venta.update');
    Route::delete('{codVenta}', [VentaController::class, 'destroy'])->name('venta.destroy');
});
