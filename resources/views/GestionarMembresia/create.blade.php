...
<div class="container">
    <div class="row">
        <div class="col-12">
            <!-- Tarjeta para el formulario de venta -->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content border-success">
                ...
                <div class="modal-body">
                    ...
                    <!-- Información del servicio seleccionado en un card -->
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const telefono = document.getElementById('telefono'); // Seleccionar el campo del teléfono
    const codClienteF = document.getElementById('codClienteF'); // Seleccionar el campo codClienteF
    const tnTelefono = document.getElementById('tnTelefono'); // Seleccionar el campo tnTelefono
        ...
        fetch(`/membresia/buscar-cliente?query=${query}`)
            ...
            .then(data => {
                ...
                data.forEach(cliente => {
                    ...
                    item.dataset.telefono = cliente.telefono; // Guardar el teléfono en el dataset
                    item.addEventListener('click', () => {
                        buscarCliente.value = `${cliente.nombre} ${cliente.apellidoPaterno}`;
                        // Asignar el teléfono al campo correspondiente
                        telefono.value = cliente.telefono;
                        codClienteF.value = cliente.carnetIdentidad; // Asignar el carnetIdentidad al campo correspondiente
                        tnTelefono.value = cliente.telefono; // Asignar el teléfono al campo tnTelefono

                        // Verificar en la consola
                        console.log('Cliente seleccionado:', cliente);
                        console.log('Número de teléfono:', cliente.telefono);
